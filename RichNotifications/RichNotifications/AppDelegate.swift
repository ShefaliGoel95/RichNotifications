...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func requestPermissionsWithCompletionHandler(completion: ((Bool) -> (Void))? ) {
        ...
        // request the user permissions to send notifications related to the app. UNAuthorizationOptions let you define which permissions you want to grant to the app.
